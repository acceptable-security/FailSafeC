...
TEST_CASE(tgamma_2)
{
  ...
  static struct {
    ...
    { NAN } ,
    { NAN } ,
    { 0x1.1191a68f2b5dfp+0 } ,
    { 0x1.e71772b7348d9p-1 } ,
    { -0x1.52420fa9e47ecp+3 } ,
    { 0x1.36dfb1a2b1479p+3 } ,
